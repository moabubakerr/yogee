...
GoRouter createRouter(AppStateNotifier appStateNotifier) => GoRouter(
      ...
      errorBuilder: (context, state) =>
          appStateNotifier.loggedIn ? DashboardWidget() : EnterypageWidget(),
      routes: [
        FFRoute(
          name: '_initialize',
          path: '/',
        ...
        FFRoute(
          name: ReportpostWidget.routeName,
          path: ReportpostWidget.routePath,
          builder: (context, params) => ReportpostWidget(
        ...
        FFRoute(
          name: NoteWidget.routeName,
          path: NoteWidget.routePath,
          builder: (context, params) => NoteWidget(
            note: params.getParam(
              'note',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['written_note'],
            ),
          ),
        ),
        FFRoute(
        ...
        FFRoute(
          name: NewEmailWidget.routeName,
          path: NewEmailWidget.routePath,
          builder: (context, params) => NewEmailWidget(),
        ),
        FFRoute(
        ...
        FFRoute(
          name: TestPlayerWidget.routeName,
          path: TestPlayerWidget.routePath,
          builder: (context, params) => TestPlayerWidget(
        ...
        FFRoute(
          name: WritenoteWidget.routeName,
          path: WritenoteWidget.routePath,
          builder: (context, params) => WritenoteWidget(
            noteref: params.getParam(
              'noteref',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['written_note'],
        ...
        FFRoute(
          name: CreatevoicenoteWidget.routeName,
          path: CreatevoicenoteWidget.routePath,
          builder: (context, params) => CreatevoicenoteWidget(
            note: params.getParam(
              'note',
              ParamType.DocumentReference,
              isList: false,
        ...
        FFRoute(
          name: PlaylistsWidget.routeName,
          path: PlaylistsWidget.routePath,
          builder: (context, params) => PlaylistsWidget(
            playlist: params.getParam(
              'playlist',
              ParamType.DocumentReference,
              isList: false,
              collectionNamePath: ['playlists'],
            ),
          ),
        ),
        FFRoute(
          name: EnterypageWidget.routeName,
          path: EnterypageWidget.routePath,
          builder: (context, params) => EnterypageWidget(),
        ),
        FFRoute(
