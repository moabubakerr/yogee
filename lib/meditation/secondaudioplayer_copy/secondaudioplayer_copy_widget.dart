...
import 'secondaudioplayer_copy_model.dart';
export 'secondaudioplayer_copy_model.dart';

class SecondaudioplayerCopyWidget extends StatefulWidget {
  const SecondaudioplayerCopyWidget({
    super.key,
    required this.songs,
  });
  ...
  @override
  State<SecondaudioplayerCopyWidget> createState() =>
      _SecondaudioplayerCopyWidgetState();
}

class _SecondaudioplayerCopyWidgetState
    extends State<SecondaudioplayerCopyWidget> {
  late SecondaudioplayerCopyModel _model;
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => SecondaudioplayerCopyModel());
