...
import 'schema/written_note_record.dart';
...
export 'schema/written_note_record.dart';
...
/// Functions to query WrittenNoteRecords (as a Stream and as a Future).
Future<int> queryWrittenNoteRecordCount({
  Query Function(Query)? queryBuilder,
  int limit = -1,
}) =>
    queryCollectionCount(
      WrittenNoteRecord.collection,
      queryBuilder: queryBuilder,
      limit: limit,
    );

Stream<List<WrittenNoteRecord>> queryWrittenNoteRecord({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
    queryCollection(
      WrittenNoteRecord.collection,
      WrittenNoteRecord.fromSnapshot,
      queryBuilder: queryBuilder,
      limit: limit,
      singleRecord: singleRecord,
    );

Future<List<WrittenNoteRecord>> queryWrittenNoteRecordOnce({
  Query Function(Query)? queryBuilder,
  int limit = -1,
  bool singleRecord = false,
}) =>
